...
describe("list", function () {
  it("len", function () {
    ...
    assert.deepStrictEqual(
      len(cons(3n, cons(2n, cons(1n, cons(0n, nil))))),
      4n
    );
  });
  ...
  it("equal", function () {
    ...
    assert.deepStrictEqual(
      equal(cons(7n, nil), cons(1n, cons(2n, nil))),
      false
    );
    ...
    assert.deepStrictEqual(
      equal(cons(5n, nil), cons(5n, cons(1n, nil))),
      false
    );
    // 0-1-many: 1 recursive call - path ends in second branch
    assert.deepStrictEqual(
      equal(cons(4n, cons(1n, nil)), cons(4n, nil)),
      false
    );
    assert.deepStrictEqual(
      equal(cons(6n, cons(1n, cons(2n, nil))), cons(6n, nil)),
      false
    );
    // 0-1-many: 1 recursive call - path ends in third branch
    assert.deepStrictEqual(
      equal(cons(5n, cons(1n, nil)), cons(5n, cons(2n, nil))),
      false
    );
    assert.deepStrictEqual(
      equal(cons(9n, cons(3n, nil)), cons(9n, cons(4n, cons(2n, nil)))),
      false
    );

    // 0-1-many: 2 recursive calls
    assert.deepStrictEqual(
      equal(cons(4n, cons(3n, nil)), cons(4n, cons(3n, nil))),
      true
    );
    assert.deepStrictEqual(
      equal(
        cons(7n, cons(6n, cons(1n, cons(4n, nil)))),
        cons(7n, cons(6n, cons(1n, cons(4n, nil))))
      ),
      true
    );
    assert.deepStrictEqual(
      equal(
        cons(4n, cons(3n, cons(2n, nil))),
        cons(4n, cons(3n, cons(1n, cons(2n, nil))))
      ),
      false
    );
  });
  ...
  it("concat", function () {
    ...
    assert.deepStrictEqual(
      concat(nil, cons(1n, cons(2n, nil))),
      cons(1n, cons(2n, nil))
    );
    // 0-1-many: 1 recursive call
    assert.deepStrictEqual(concat(cons(1n, nil), nil), cons(1n, nil));
    assert.deepStrictEqual(
      concat(cons(1n, nil), cons(2n, nil)),
      cons(1n, cons(2n, nil))
    );
    assert.deepStrictEqual(
      concat(cons(1n, nil), cons(2n, cons(3n, nil))),
      cons(1n, cons(2n, cons(3n, nil)))
    );
    // 0-1-many: 2+ recursive call
    assert.deepStrictEqual(
      concat(cons(1n, cons(2n, nil)), nil),
      cons(1n, cons(2n, nil))
    );
    assert.deepStrictEqual(
      concat(cons(1n, cons(2n, nil)), cons(3n, nil)),
      cons(1n, cons(2n, cons(3n, nil)))
    );
    assert.deepStrictEqual(
      concat(cons(1n, cons(2n, nil)), cons(3n, cons(4n, nil))),
  ...
  it("rev", function () {
    ...
    // 0-1-many: 2+ recursive calls
    assert.deepStrictEqual(
      rev(cons(1n, cons(2n, nil))),
      cons(2n, cons(1n, nil))
    );
    assert.deepStrictEqual(
      rev(cons(1n, cons(2n, cons(3n, nil)))),
  ...
  it("remove", function () {
    ...
    assert.deepStrictEqual(
      remove(1n, cons(1n, cons(2n, cons(3n, nil)))),
      cons(2n, cons(3n, nil))
    );
  });
  ...
  it("suffix", function () {
    ...
    assert.deepStrictEqual(
      suffix(1n, l5),
      cons(2n, cons(3n, cons(4n, cons(5n, nil))))
    );
    // 0-1-many: many recursive calls
  ...
  it("compact_list", function () {
    ...
    assert.deepStrictEqual(compact_list(cons(3n, cons(2n, cons(1n, nil)))), [
      3n,
      2n,
      1n,
    ]);
