...
describe('fib', function() {
  ...
  it('fib', function() {
    assert.deepStrictEqual(fib(0n), 0n);
    assert.deepStrictEqual(fib(1n), 1n);
    assert.deepStrictEqual(fib(2n), 1n);
    assert.deepStrictEqual(fib(3n), 2n);
    assert.deepStrictEqual(fib(11n), 89n);
  });
